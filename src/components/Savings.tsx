    ...
    <div className="animate-fade-in-up">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <div className="bg-success/10 border border-success/20 rounded-2xl p-4">
          ...
          <div className="text-sm sm:text-lg font-extrabold text-foreground truncate">{fmt(netSavings)}</div>
        </div>
        <div className="bg-warning/10 border border-warning/20 rounded-2xl p-4">
          <div className="text-[0.65rem] font-extrabold uppercase text-muted-foreground mb-1">Aportes</div>
          <div className="text-sm sm:text-lg font-extrabold text-foreground truncate">{fmt(totalContributions)}</div>
        </div>
      </div>
